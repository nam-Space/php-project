...
$product = array(
    1 => array(
        'post_thumb' =>  './assets/images/stock_5.jpg',
        'card_header' => 'Kinh doanh online'
    ),
    2 => array(
        'post_thumb' =>  './assets/images/stock_1.jpg',
        'card_header' => 'Kinh doanh online'
    ),
    3 => array(
        'post_thumb' =>  './assets/images/stock_3.jpg',
        'card_header' => 'Kinh doanh online'
    ),
    4 => array(
        'post_thumb' =>  './assets/images/stock_4.jpg',
        'card_header' => 'Kinh doanh online'
    ),
    5 => array(
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 content">
                            <h5 class="text-light mt-3 bg-danger p-2 d-inline-block rounded">CHỨNG KHOÁN</h5>
                            <div class="row">
