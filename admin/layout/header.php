...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="icon" href="https://quydung.unitopcv.com/public/images/klipartz.com.png">
    ...
    <script src="Tool/Plugin/Jquery/jquery.js"></script>
        ...
        <div id="container">
            <div id="header-wp">
                <div class="wp-inner clearfix">
                    <a href="?page=list_post" title="" id="logo" class="fl-left text-danger">ADMIN</a>
                    ...
                    <div id="dropdown-user" class="dropdown dropdown-extended fl-right">
                        <button class="dropdown-toggle clearfix" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            ...
                            <img src="<?php if (empty(info_user(user_login(), 'avt'))){ echo "https://c2.staticflickr.com/8/7628/27739307291_c43b62d5df_b.jpg";}else{echo info_user(user_login(), 'avt');} ?>">
                            </div>
